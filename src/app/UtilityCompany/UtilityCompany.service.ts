...
import { UtilityCompany } from '../network.energy.fazezero';

import { DataService } from '../data.service';

import { Coins, Energy } from '../network.energy.fazezero';
...
export class UtilityCompanyService {
	...
	//update resident
	public updateUtilityCompany(
		id: any,
		itemToUpdate: any
	): Observable<UtilityCompany> {
		return this.utilityCompanyService.update(
			this.UTILITYCOMPANY,
			id,
			itemToUpdate
		);
